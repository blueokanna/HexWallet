...
const CatalogSeed kCatalog[] = {
    ...
    {"eth", "ETH", "Ethereum", 60, WalletCapabilityAddress, "eth", "address only"},
    {"etc", "ETC", "Ethereum Classic", 61, WalletCapabilityAddress, "etc", "address only"},
    ...
    {"opt", "OPT", "Optimism", 614, WalletCapabilityAddress, "opt", "address only"},
    {"matic", "MATIC", "Polygon", 966, WalletCapabilityAddress, "matic", "address only"},
    {"ftm", "FTM", "Fantom", 1007, WalletCapabilityAddress, "ftm", "address only"},
    {"base", "BASE", "Base", 8453, WalletCapabilityAddress, "base", "address only"},
    {"avax", "AVAX", "Avalanche", 9000, WalletCapabilityNone, nullptr, "X/P-Chain address stack not implemented"},
    {"arb1", "ARB1", "Arbitrum", 9001, WalletCapabilityAddress, "arb1", "address only"},
    {"avaxc", "AVAXC", "Avalanche C-Chain", 9005, WalletCapabilityAddress, "avaxc", "address only"},
    {"bsc", "BSC", "Binance Smart Chain", 9006, WalletCapabilityAddress, "bsc", "address only"},
    ...
    {"xmr", "XMR", "Monero", 128, WalletCapabilityNone, nullptr, "ed25519/Keccak wallet not implemented"},
    ...
    {"cro", "CRO", "Crypto Chain", 394, WalletCapabilityNone, nullptr, "Crypto.org address and transaction stack not implemented"},
